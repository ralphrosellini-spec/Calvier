  ...
  return (
    <div className="bg-cr-black min-h-screen">
      ...
      <section className="relative h-[80vh] min-h-[600px] flex items-center justify-center">
        ...
        >
          <p className="text-cr-gold text-[10px] tracking-[0.4em] uppercase mb-6">Maison FondÃ©e en 1984</p>
      ...
      <section className="py-24 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="prose prose-invert prose-lg mx-auto">
          ...
          <p className="text-white/60 leading-relaxed mb-6 text-justify">
            Every garment and accessory bearing the CALVIER ROSSEL name passes through the hands of master artisans. Our ateliers in Paris and Milan are sanctuaries of slow fashion, where centuries-old techniques are preserved and elevated. We believe that true luxury lies in the unseen details â₹” the perfect tension of a hand-stitched seam, the precise cut of a lining, the unparalleled quality of bespoke leather sourced from the world&apos;s finest tanneries.
          </p>
          ...
          <blockquote className="my-16 border-l-2 border-cr-gold pl-8 py-4">
            <p className="font-serif text-2xl font-light text-white italic leading-relaxed">
              &ldquo;We do not make clothes for the moment. We sculpt armor for the modern era â₹” garments that empower the wearer to command any room they enter.&rdquo;
            </p>
            <footer className="text-cr-gold text-[10px] tracking-widest uppercase mt-4">â₹” Calvier Rossel</footer>
          </blockquote>
